                    ...
                    <div class="span8 page-content">
                            ...
                            <div class="row separator">
                            		<section class="span4 articles-list">
                                            <h3><a href="#">戏曲常识普及</a></h3>
                                            <ul class="articles">
                                            	<c:forEach items="${list }" var="listss">
                                            		<li class="article-entry standard">
                                                            <h4><a href="zhishiDetail.html?id=${listss.id }">${listss.title }</a></h4>
                                                            <span class="article-meta">(${listss.showDate })</span>
                                                            <img src="${ctx }/${listss.pic}" style="width: 200px;height: 200px;">
                                                    </li>
                                            	</c:forEach>
