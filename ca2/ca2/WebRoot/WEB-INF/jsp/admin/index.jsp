    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                <a class="navbar-brand" href="index.html"><strong><i class="icon fa"></i>戏曲网</strong></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li><a href="${ctx}/admin/wdxx/frame.html?flag=1&bkId=1" target="ifContent"><i class="fa fa-file"></i>用户戏曲审核管理</a></li>
                    <li><a href="${ctx}/admin/pinglun/frame.html?flag=1&bkId=1&flag=1" target="ifContent"><i class="fa fa-file"></i>评论管理</a></li>
                    <li><a href="${ctx}/admin/ltsm/edit.html" target="ifContent"><i class="fa fa-file"></i>网站公告</a></li>
                    <li>
                        <a href="#"><i class="fa fa-file"></i>统计中心<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="${ctx}/admin/tj/tj1.html" target="ifContent"><i class="fa fa-file"></i>按天统计信息发送数量</a></li>
                            <li><a href="${ctx}/admin/tj/tj2.html" target="ifContent"><i class="fa fa-file"></i>按天统计注册用户数量</a></li>
						</ul>
					</li>
					<li><a href="${ctx}/admin/hd/frame.html?flag=1" target="ifContent"><i class="fa fa-file"></i>活动列表</a></li>
                    <li><a href="${ctx}/admin/zhishi/frame.html?flag=1" target="ifContent"><i class="fa fa-file"></i>戏曲常识列表</a></li>
                    <li><a href="${ctx}/admin/zhishilist/frame.html?flag=1" target="ifContent"><i class="fa fa-file"></i>戏曲常识交流列表</a></li>
					<%--<li>
