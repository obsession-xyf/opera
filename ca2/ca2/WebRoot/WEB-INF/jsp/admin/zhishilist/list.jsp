...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="戏曲常识" property="title"/>
			<display:column title="用户" property="name"/>
			<display:column title="文字" property="content"/>
	...
	function updateColumnzhishiId(zhishiId,id){
		if(!confirm("确定要更新为"+zhishiId+"吗?")){
			return false;
		}
		//var aaa = prompt("请输入操作意见或说明：","");
		var params={id:id,zhishiId:zhishiId};
		$.post("updateColumnzhishiId.html",params,function(
				result){
			result=eval("("+result+")");
